...
void generateEvidence() {
    ...
    for(int ix=0; ix<n_x; ix++){
        for(int iy=0; iy<0.5*n_y; iy++){
            addEvidence(world_evidence, 2*ix*box, 2*iy*box, 0, "checkers", "black");
            addEvidence(world_evidence, 2*ix*box+box, 2*iy*box+box, 0, "checkers", "black");
        }
    }
...
//    for(int ix=0; ix<n_x; ix++){
//        for(int iy=0; iy<0.5*n_y; iy++){
//            addEvidence(world_evidence, 2*ix*box, 2*ix*box+4, 0, "checkers", "white");
//            addEvidence(world_evidence, 2*ix*box+box, 2*ix*box+box+4, 0, "checkers", "white");
//        }
//    }
	// Publish results
